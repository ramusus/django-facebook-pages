...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'facebook_pages_page', 'phone', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Page.phone'
        db.alter_column(u'facebook_pages_page', 'phone', self.gf('django.db.models.fields.CharField')(max_length=100))
